...
#Path Handler
#py installer expect to find accests in a temproary folder named sys._MEIPASS2
...
SPRITES["background"] = pygame.image.load(resource_path(
    "gallery\sprites\\background.png"
)).convert_alpha()
SPRITES["start"] = pygame.image.load(resource_path("gallery\sprites\start.png")).convert_alpha()
SPRITES["exit"] = pygame.image.load(resource_path("gallery\sprites\exit.png")).convert_alpha()
SPRITES["dev"] = pygame.image.load(resource_path("gallery\sprites\dev.png")).convert_alpha()
SPRITES["title"] = pygame.image.load(resource_path("gallery\sprites\\title.png")).convert_alpha()
SPRITES["instructions"] = pygame.image.load(resource_path(
    "gallery\sprites\instructions.png"
)).convert_alpha()
SPRITES["credits"] = pygame.image.load(resource_path("gallery\sprites\credits.png")).convert_alpha()
SPRITES["next"] = pygame.image.load(resource_path("gallery\sprites\\next.png")).convert_alpha()
SPRITES["back"] = pygame.image.load(resource_path("gallery\sprites\\back.png")).convert_alpha()
SPRITES["mainmenu"] = pygame.image.load(resource_path("gallery\sprites\mainmenu.png")).convert_alpha()
SPRITES["replay"] = pygame.image.load(resource_path("gallery\sprites\Replay.png")).convert_alpha()
SPRITES["icon"] = pygame.image.load(resource_path("gallery\sprites\icon256.ico")).convert_alpha()

SPRITES["github"] = pygame.image.load(resource_path("gallery\sprites\github.png")).convert_alpha()
SPRITES["mail"] = pygame.image.load(resource_path("gallery\sprites\mail.png")).convert_alpha()
SPRITES["twitter"] = pygame.image.load(resource_path("gallery\sprites\\twitter.png")).convert_alpha()
SPRITES["telegram"] = pygame.image.load(resource_path("gallery\sprites\\telegram.png")).convert_alpha()
SPRITES["linkedin"] = pygame.image.load(resource_path("gallery\sprites\linkedin.png")).convert_alpha()
SPRITES["replit"] = pygame.image.load(resource_path("gallery\sprites\\replit.png")).convert_alpha()
SPRITES["discord"] = pygame.image.load(resource_path("gallery\sprites\discord.png")).convert_alpha()
SPRITES["developerContact"] = pygame.image.load(resource_path(
...
SPRITES["numbers"] = (
    pygame.image.load(resource_path("gallery\sprites\\0.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\1.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\2.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\3.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\4.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\5.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\6.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\7.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\8.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\9.png")).convert_alpha(),
)


# Loading Sprites Player/Rocket
SPRITES["player"] = (
    pygame.image.load(resource_path("gallery\sprites\\rocketa.png")).convert_alpha(),
    pygame.image.load(resource_path("gallery\sprites\\rocketb.png")).convert_alpha(),
)
...
SPRITES["pipe"] = (
    pygame.transform.flip(
        pygame.image.load(resource_path("gallery\sprites\pole.png")).convert_alpha(), False, True
    ),
    pygame.image.load(resource_path("gallery\sprites\pole.png")).convert_alpha(),
)


# Loading Sprites InGame
SPRITES["gameover"] = pygame.image.load(resource_path("gallery\sprites\gameover.png")).convert_alpha()
SPRITES["message"] = pygame.image.load(resource_path("gallery\sprites\message.png")).convert_alpha()
SPRITES["base"] = pygame.image.load(resource_path("gallery\sprites\\base.png")).convert_alpha()
SPRITES["score"] = pygame.image.load(resource_path("gallery\sprites\score.png")).convert_alpha()


# Loading Sounds
pygame.mixer.music.load(resource_path("gallery\sounds\opening.mp3"))
SOUNDS["click"] = pygame.mixer.Sound(resource_path("gallery\sounds\click.mp3"))
SOUNDS["points"] = pygame.mixer.Sound(resource_path("gallery\sounds\points.mp3"))
SOUNDS["gameover"] = pygame.mixer.Sound(resource_path("gallery\sounds\gameover.mp3"))
SOUNDS["die"] = pygame.mixer.Sound(resource_path("gallery\sounds\die.mp3"))
